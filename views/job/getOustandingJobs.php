<h1>Customer With Outstanding Fees</h1>
...
<table id="oustandingJobDT" cellspacing="0">
    <thead>
        <tr>
            ...
            <th>Paid Amount</th>
            <th class="attention">Outstanding Fee</th>
            <th>Payment Remark</th>
        </tr>
    </thead>
    <tbody>
        <?php
        foreach ($this->outstandingJobs as $job) {
            ...
            $job['Paid'] . "</td><td class='attention'>$" .
            $job['Outstanding'] . "</td><td>" .
